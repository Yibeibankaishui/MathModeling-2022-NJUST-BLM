...
typedef struct
{
  double Inf;   // infection
  double Symp;  // symptom
  double Hosp;  // hospitalization
  double Death; // death
  double OT;    // onward transmission
  double rate4R2S;  // rate for recovery
  double rate4V;  // rate for vaccination transition
} VE;   // 12 col
